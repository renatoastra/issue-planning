...
export const Room = ({ id }: RoomProps) => {
  ...
  const { isLoadingRoomQueries, isMutatingOnResetRoom } =
  ...
  return (
    <>
      ...
      <div className="relative flex h-[calc(100vh-89px)] w-full  items-center  ">
        <UserSideBar />
        {isLoadingRoomQueries && <PageLoadingSkeleton />}
        ...
        {!isLoadingRoomQueries && (
          <FadedComponent className="flex h-full  w-[calc(100%-12.23rem)] flex-col   items-center justify-between  gap-6  ">
           ...
           - Avaliar o tempo gasto com possíveis ajustes que ocorram durante a issue.`}
                        ...
                        <div className="flex justify-between">
                          ...
                          <div className="flex w-48 flex-col gap-2">
                            ...
                            <Button
                              ...
                              disabled={!handleTimer || isLoading}
                        ...
                        <div className="flex w-full items-center justify-between">
                          <div>
                            <Button
                              ...
                              disabled={!canRevealVote || isMutatingOnResetRoom}
                              onClick={async () => handleResetVote()}
                            >
                              <LoadingSpinner
                                text="Reset votes"
                                isLoading={isMutatingOnResetRoom}
                              />
                            </Button>
              ...
              {step === ROOM_STATUS.VOTED ? (
                <div className="flex  w-96 flex-col items-center justify-center gap-6 xl:w-full">
